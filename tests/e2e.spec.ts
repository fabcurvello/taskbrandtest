...
test('deve adicionar uma tarefa', async ({ page }) => {
  ...
  await page.getByPlaceholder('Digite o título').fill('Estudar Playwright');

  await page.getByPlaceholder('Detalhes da tarefa').fill('Criar testes E2E');
...
test('deve concluir uma tarefa', async ({ page }) => {
  ...
  await page.getByPlaceholder('Digite o título').fill('Tarefa para concluir');

  await page.getByPlaceholder('Detalhes da tarefa').fill('Detalhes da tarefa');
...
test('deve remover uma tarefa', async ({ page }) => {
  ...
  await page.getByPlaceholder('Digite o título').fill('Tarefa para remover');

  await page.getByPlaceholder('Detalhes da tarefa').fill('Será removida em seguida');
